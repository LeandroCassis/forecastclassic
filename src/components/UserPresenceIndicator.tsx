        ...
        {displayUsers.map((onlineUser) => (
          <TooltipProvider key={onlineUser.id}>
            <Tooltip>
              <TooltipTrigger asChild>
                <div 
                  className="h-6 w-6 rounded-full bg-blue-500 flex items-center justify-center text-white text-xs font-medium ring-2 ring-white"
                >
                  {onlineUser.initials}
                </div>
              </TooltipTrigger>
